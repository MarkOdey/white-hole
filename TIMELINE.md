...
A journal-format novel following one woman from age 10 through her final year on Earth, then into an unknown new world. A rogue planet on a hyperbolic trajectory strikes the sun, triggering years of solar chaos — and, far more quietly, destabilizing the solar system's orbital mechanics past recovery on a timescale of decades. A handful of specialists work this out early and are censored to prevent panic. Behind that censorship, an international coalition initiated by China — the only power with the industrial capacity for it — covertly begins building 10,000 paired arks, each carrying two humans (by design, for companionship and eventual parenthood) plus a full biological repository, to be launched toward neighboring star systems in staged waves. The program is not disclosed to the public until years after the impact, when Earth's weather has made the case that no announcement could. Then a second object arrives that no model predicted, and the launch schedule dies. The protagonist loses her male crewmate before departure and launches alone through a world whose institutions no longer function well enough to stop her. At the moment of her ark's departure, a black hole — in truth one mouth of a tunnel spanning millions of light-years, opened eons ago by a vast, non-human intelligence — arrives and consumes Earth. She and her ark are pulled through to the other side: a nebular micro-gravity environment, no up or down, rich in resources, breathable, water-abundant — part remnant of her old world, part something entirely new. There, she will eventually meet the being whose tunnel brought her there.

---

## Cosmological Backstory: The Entity and the Tunnel

Millions of years before the story begins, a vast, non-corporeal intelligence — an entity composed of self-sustaining electrical/electromagnetic energy rather than matter, capable of telekinesis and of exerting influence over magnetic phenomena, functionally long-lived but not truly immortal — calculates, through means far beyond human science, that a rogue planet will one day cross into a particular solar system and set it on an irreversible path toward orbital collapse and system-wide collision, annihilating all life within it.

Acting on this prediction long in advance, the entity opens a tunnel — a black hole mouth positioned to arrive near the doomed system, a white hole mouth on its own side of the universe, millions of light-years away — timed to arrive at approximately the point of no return, so that whatever life remains can be pulled through and preserved before the collision cascade makes rescue impossible.

The entity's tunnel is not aimed at any single planet out of sentiment or knowledge of its inhabitants — it is a preservation mechanism, tuned to capture and carry across whatever living material it can reach at the moment of arrival. It has no advance knowledge of Earth's civilization, no expectation of finding intelligent life, and is not coordinating with or aware of humanity's own parallel escape effort. The two rescue plans — one ancient and cosmic, one desperate and human — converge on the same narrow window for entirely unrelated reasons. The book should never let anyone, human or entity, mistake that convergence for design.

What the entity does not anticipate is her: a technologically evolved being capable of reasoned argument and ethical appeal (logos and ethos), arriving intact, aware, and — improbably — able to speak back.

---

## Cosmic / Disaster Timeline

**Year 0 (age 10) — Before.** The journal begins. No cosmic backdrop. Family, a possibly distracted household, and the plain want underneath everything: to confide in someone, and to be remembered. She wants to be an astronaut, earnestly and uncomplicatedly, the way ten-year-olds do.
...
**No catastrophe is announced.** The public consensus is a bad few years, not an extinction. Most people file it as scheduled weather, something to be endured on a known date, and stop thinking about it.

**Years 3–5 (age 13–15) — The Wobble and the Silence.** As the planet passes deep into the system, orbital anomalies accumulate: Mars drifts from predicted position, the Moon's orbit perturbs, tide tables run off.

A small number of specialists work the problem and reach a conclusion nobody wants: the passage is destabilizing the system's orbital mechanics beyond recovery, and the collapse will play out **within decades, not centuries.**

**The finding is censored.** Governments, facing a population already bracing for an impact, suppress it to prevent panic: papers withdrawn, funding pulled, careers quietly ended, specialists reassigned or discredited. The people who are right are made to look unreliable.
...
The reader should finish this stretch genuinely uncertain how much was true, in exactly the proportion she was. The entity, reconstructing this era from a teenager's listening history and a handful of scared entries, is even less sure — and should say so.
...
Simultaneously, a trend takes hold among the very wealthy: privately commissioned "space yachts," marketed as independent escape from the solar system. They are physically unserious — vanity architecture with no viable propulsion, shielding, or life-support horizon — and they absorb enormous capital and attention. They are the loud, visible, useless version of the thing already being built in secret.

Her entry here should do two things at once: she can dismiss the sun-explodes claim on the physics, because she is the one sixteen-year-old who actually understands the data — and she personally knows a discredited scientist, which means she is watching the censorship from very close and cannot say so.

**Year 7 (age 17) — The Impact.** The rogue planet strikes the sun. The sun does not fail. Flare activity runs worse than forecast but stays inside the predicted bracket. It is devastating and it is survivable.

The world exhales — and then, as the storms begin to bite, the relief curdles into contempt for the scientists who spent a year being shouted at about an explosion that never came. The censored are now doubly buried: discredited once by their governments, and again by a public that has decided all of them were wrong.

**Years 7–10 (age 17–20) — Flare-Storm Era.** Solar magnetic activity climbs past all historical precedent. Grid-down events, fried digital infrastructure, heatwaves in winter, blizzards in summer, storms in the wrong places at the wrong times. Seasons stop making sense. Death tolls rise from unpredictable natural disaster. Institutions begin to erode — authority becomes patchy, local, improvised.

Underneath it, covert ark construction accelerates.
...
And with time, she tells her she wants to be an astronaut.
...
**Years 10–11 (age 20–21) — Disclosure.** The Ark Project is made public.

**Adherence is immediate and enormous — and not because anyone believes the orbital verdict.** The government's admission of long-term uninhabitability is met with the same skepticism as everything else it has said. What convinces people is the weather. Earth has spent three years making the argument that no announcement could, and a population living through unlivable seasons does not require a mechanism to want out.

Recruitment pipelines open. The plan, matched to a collapse measured in decades, is a staged evacuation: ten thousand arks launched in waves over roughly twenty years, each to a different pre-identified neighboring system. Tight, but achievable. She applies.

**Years 11–13 (age 21–23) — Training.** She is selected, trained, and paired with her assigned male crewmate; the partnership deepens from professional into personal. She completes an MA in gravitational-fluctuation analysis — the ten-year-old's fascination matured into a discipline.

Around her, institutional authority continues to dissolve. This erosion is not background texture; it is the mechanism that makes the ending possible, and it should be visible accumulating across these years.
...
An older woman: a working scientist who has also flown — both halves of what the ten-year-old wants, standing in one person.
...
**Her nature — protect this.** She is not an architect of anyone's fate. No agenda, no secret knowledge she is steering the protagonist with, no plan for her, and no involvement in the censorship or the suppressed findings. She inspires kids because that is part of the job, and she vouches for a good student because the student is good. Every consequence of her presence is retroactive — visible only to a reader who already knows where the door led. She should never be written as knowing more than she does.

**She does not get a seat.** The arks select young pairs for reproduction; she is decades too old. She helped a young person through a door she was never eligible to walk through herself, and there is no indication she ever resented it.

### Her death

**She is still on Earth when the tunnel arrives, and she is taken with everything else.**

She does not survive the crossing. Neither do a great many other living things. Some do. **The cause is deliberately left unknown for now** — not withheld from the reader by a narrator who knows, but genuinely undetermined. Whatever governs who comes through intact is opaque to everyone, the entity included.

**The entity cannot account for her.** Not because it is withholding, and not because it is searching and failing — because **it does not know to look.** It does not know there were humans on that planet. It has no concept that the material it collected contained persons, let alone particular ones with names. When the protagonist asks after her, she is asking a question the entity does not have the category to parse.
...
Assigned to her during training (Yr 11–13). The pairing is by program design — one woman, one man, for companionship and eventual joint parenthood on arrival — and it becomes personal as well as professional over the years they train together.

### His death

**Timing:** the public announcement of the second object, when it becomes clear the staged twenty-year evacuation is dead and the plan has gone south. He does not survive that news intact. He has a breakdown.

**The exchange — preserve this verbatim:**

> "Do you believe in god?"
>
> "I don't know... it's late, maybe we should go to bed."
>
> "For what? Another broken tomorrow with no hope? I used to not believe in God but now I do. And I think he is there to punish us. For the disrespect we brought on to his creation. For the greed, foolishness and cowardice. We are all going to hell."
>
> "How could God hate his own creation?"
...
**A note on his theology.** He converts under catastrophe and converts immediately to a punishing god — greed, foolishness, cowardice, hell. That is a recognizable way for a terrified person to reach for meaning: a universe that is cruel on purpose is easier to bear than one that is indifferent. Her reply refuses it without offering a replacement. Neither of them is right, and what actually arrives is stranger than either position.
...
**Age 13–15 (Yr 3–5):** The Wobble. The mentor is censored — retracted, defunded, quietly discredited. The protagonist is thirteen to fifteen and watching it happen to someone she admires, without the standing or vocabulary to do anything. A personal loss or disappointment in this window turns her vague wish to be remembered into a real fear. She commits to physics as a path rather than a fantasy.

**Age 16 (Yr 6):** The conspiracy, the panic, the denials, the space yachts. She is the one person in her orbit who can read the data, and she knows a silenced scientist personally. First full taste of the position she will occupy for the rest of her life: knowing more than the people around her and getting no comfort from it.

**Age 17 (Yr 7):** The impact. The sun survives. The world's relief turns into contempt for the scientists she has decided to become — and buries the censored a second time.

**Age 17–20 (Yr 7–10):** Flare-storm era as lived experience. Blackouts, freak weather, infrastructure strain, deaths at a distance and then not at a distance. University. She is studying a discipline the public now holds in contempt, taught partly by someone the state discredited.

**Age 20–21 (Yr 10–11):** Disclosure. The mentor gets her in. Her first real setback or rejection in the process lives privately in the journal, since she'd never show it outwardly.

**Age 21–23 (Yr 11–13):** Training era. Meets and is paired with her crewmate; professional partnership becomes personal. Completes her MA on gravitational-fluctuation analysis. Around her, authority quietly dissolves.

**Age 23–24 (Yr 13–14):** Her thesis surfaces the second object days before official confirmation — found by the same method that captured her at ten. The staged evacuation detonates into emergency launch.
...
## The Opening (first page)

The book opens on the entity **greeting the reader** — not narrating, not scene-setting. Meeting us.
...
That is the whole page. It should feel like being seated across from someone who is happy you came, and who mentions — the way lonely people do, early and without weighing it — the person they lost.

**Craft notes:**

- **Do not name her, and do not signal that she is the subject of the book.** She should arrive as a fond aside from a stranger. The reader shouldn't realize until later that everything following is the elaboration of one offhand sentence on page one.
- **"Long passed" is the load-bearing phrase.** It establishes both that she is dead and that a great deal of time has gone by since — enough that the entity's grief has cooled into something conversational. The book is not narrated from fresh loss. It is narrated from a very old one, by something that has had a long time to sit with it.
- **The register is calm and fond, not grand.** No cosmic pronouncement, no vast-intelligence throat-clearing. The scale should be discoverable later, and land harder for being withheld here.
- **The idiom near-misses start here, but lightly.** One, maybe. Enough to leave the reader faintly unsure who is talking. Not enough to be a bit.
- **The reader's status stays ambiguous.** Whether we are physically present, newly arrived, or simply being addressed is not established and should not be. The uncertainty is productive and costs nothing.

**Structural consequences to be aware of:**
...
## The Far Side (second movement)

Everything above is the first movement. The Earth timeline ends at the crossing; this is the rest of the book, and it is comparably long.

### 1. Alone, first

She arrives ahead of everything. An interval — length undetermined — entirely by herself, before anything follows. Then her world arrives behind her, in pieces, over time: a quarter of Earth coming through in fragments, unrecognizable, drifting. She does not watch Earth end. She watches it arrive after her.
...
They bond. This is the long warm centre of the book and it should be genuinely warm — not ironized, not undercut by the reader knowing how it ends.

Consider what each is getting. She has spent her entire life wanting to be confided in and remembered, and now has a companion that can read her thoughts, has unlimited time, and is completely fascinated by her. It has existed for millions of years as a mechanism executing a plan, and has just discovered that minds exist, that it is capable of fondness, and that it can be spoken to.

Neither has ever had this. Both are catastrophically bad at it.

### 4. Building — the flat world
...
- The joke works: every flat-earther was wrong about the world they were born on and right about the one at the end of the book.
- The reason is not a joke. **On a flat world nothing goes over the horizon.** Nothing recedes and vanishes; you can see to the edge. For a woman defined by loss and by the terror of being forgotten, building a world where nothing can disappear is a psychological decision, and she should never quite say so aloud.
- She knows better. That is the point. She is not mistaken about cosmology; she is choosing against it.

Slowly it becomes an Eden. Growing things, water, air, animals from the repository. The Genesis vocabulary — firmament, the waters, the garden — sits there unremarked. Neither comments on the resemblance: she would know exactly what she was doing, and the entity has never heard of Genesis.

**Critically, this era is good because she is needed.** There is work, and difficulty, and things that fail and must be solved. She has purpose. Hold that — it is what makes the next section land.
...
The entity is devoted, attentive, and effectively omnipotent within this world. That is the problem. A being that can do anything for her leaves her nothing to do. Difficulties are removed before she reaches them. Needs are met before she names them. The garden is finished, and a finished garden tended by a god does not require a gardener.

What that strips away is exactly what distinguishes a person from a well-kept animal: **free will, freedom, and the struggle to overcome one's own challenges.** She is fed, safe, warm, adored, and observed. She is in a zoo. An excellent zoo, built with love, by a keeper who would be genuinely wounded to hear it called one.

**And the enclosure is made of the thing she wanted her whole life.** She wanted to be known. She is now perfectly known — thoughts, memories, everything, continuously, with no interior that is hers alone. The wish came true at full strength, and it turns out a self requires some part of itself to go unwitnessed. Her lifelong longing, granted completely, is the glass wall.

Everything she ever was, she earned against resistance: the applications, the rejections, the training, the thesis nobody asked her to write, the seat she took by silence. Remove resistance and you remove her. She would rather be a person with problems than a specimen without them.
...
She plans the departure. And then — this is the hinge of the entire second movement — **the entity chooses to let her.**
...
Which is also the cruellest thing available to it, and it does it anyway. A being that had waited millions of years for company chose permanent ignorance of the only person it ever cared about, because she needed the ignorance more than it needed the knowing.

**The Eden is left humanless.** Nobody remains. This constrains the child question hard: either she never had one, or whoever she had went with her. The garden she spent a lifetime building continues without a single person in it — growing, watered, lit, empty.
...
### 8. The reader arrives

Someone human turns up. **Who they are is deliberately unspecified** — another survivor of the crossing who has been out there all along, or a descendant of hers who came back, or something else. The entity does not say, may not know, and the book never resolves it.

**This is what the opening page is standing in.** The entity's gladness, its rustiness, its remark that things were loud once and are very calm now — that is the loneliness of something that built a paradise with someone who left. The quiet it jokes about having wanted is her absence. It is sitting in an abandoned Eden telling a stranger about the woman who made it and walked away, and it is not bitter, which is worse.
...
- **Relinquishment — the entity's one moral act:** Total witness was the cage, so it gives up witnessing. It lets her go, refuses to follow, and permanently declines to know what became of her. A being that waited millions of years for company chooses lasting ignorance of the only person it ever loved, because she needs the ignorance more than it needs the knowing. It learned ethics from her, and the first thing ethics required was losing her.
- **The unexamined grief:** Because it never looked, it does not know she died — it only knows enough time has passed that she must have. The novel's calmest sentence is an inference the speaker has never once tested.
- **Cosmic irony:** Humanity spends its final months terrified of what it reads as a second, crueler extinction, never knowing the same object is an ancient, deliberate rescue — arriving on schedule for reasons unrelated to humanity's own escape effort. **And the terror was not misplaced.** The rescue is real and it kills most of what it collects. Both are true at once; neither cancels the other. Do not let the book resolve this into either "they were wrong to be afraid" or "it was never a rescue."
- **The fallible god:** The entity is vast, ancient, and well-intentioned. It prepared a habitat with genuine care — pressure, breathable air, water — and the mechanism largely works. It is still not omniscient and not infallible. It does not know what it lost because it never knew what it had, and it cannot undo any of it. Its errors should have weight and consequence, never charm.
- **The conspiracy that was right:** At Year 6 the public correctly infers concealment and correctly infers preparation, and gets only the catastrophe wrong. The same error the species makes about the black hole at the end, rehearsed nine years early at human scale.
- **Censorship as ambient weather:** The suppression era reaches her only through media — podcasts, leaked documents, a jailed spokesperson, her own scared entries. She never confirms any of it. The lesson lands anyway: being right and being heard are unrelated. She cashes it in at twenty-four when she declines to escalate what she knows.
- **The loud useless escape:** Billionaire space yachts absorb capital, attention, and hope while the real vessel is built in secret and denied. Visible futility as cover for invisible competence.
- **Authority dissolved, not defied:** Her seat survives because the state eroded past enforcement, not because she outfought it or was believed. She gets her seat by omission — stepping through a gap where an institution used to be.
- **Thematic throughline:** Gravitational and spacetime reasoning as her way of perceiving a reality where ordinary senses and orientation fail — bridging Earth's final crisis and the directionless new world.
- **First-contact reversal:** The entity's mechanism is tuned for biological material, not consciousness. Her arrival — intact, self-aware, capable of reasoned and ethical argument — is the anomaly it never predicted, flipping "human discovers alien" into "cosmic intelligence discovers, to its own surprise, a mind."

---

## Open Threads / Decisions Still Available

- Whether **Eva** sticks (provisional — see the note at the top), and the mentor's and crewmate's names.
- Protagonist's specific nationality within the coalition (China-instigated, but she need not be Chinese).
